...
export default function CrescentCateringCalculator() {
  ...
  useEffect(() => {
    ...
    try {
      const gc = 10, mp = 40; // basic math check
      console.assert(gc * mp === 400, "Meal subtotal math failed");
      console.assert(Math.abs(0.4 + 0.4 + 0.2 - 1) < 1e-9, "Drink mix should sum to 1");
          ...
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 min-w-0">
            ...
            <div className="lg:col-span-1 min-w-0">
              <Section title="Headcount & Meal">
                ...
                <div>
                  <div className="mb-2 text-sm text-zinc-100/90">Meal style</div>
                ...
                {mealType === "plated" ? (
                  <div className="grid gap-2">
                    ...
                    <select
                      className="w-full rounded-lg border border-zinc-600 bg-[#1b1526] text-[#EAD8B1] px-3 py-2"
                      value={platedChoice}
                ...
                <div className="mt-2 text-sm text-zinc-100/90">
              ...
              <Section title="Taxes & Service" subtitle="Editable to match contract; applied to F&B subtotal.">
                ...
                <p className="text-xs text-zinc-200/70">Tune these to your BEO.</p>
              </Section>
            </div>
            ...
            <div className="lg:col-span-1 min-w-0">
              <Section title="Appetizers" subtitle="Enter # of pieces (per item)">
                ...
                <div className="text-sm text-zinc-100/90">Apps subtotal: <span className="font-medium">${appsSubtotal.toFixed(2)}</span></div>
              </Section>
              <Section title="Displays & Boards" subtitle="Enter # of platters (serves noted)">
                ...
                <div className="text-sm text-zinc-100/90">Displays subtotal: <span className="font-medium">${displaysSubtotal.toFixed(2)}</span></div>
              </Section>
              <Section title="Sweets">
                ...
                <div className="text-sm text-zinc-100/90">Sweets subtotal: <span className="font-medium">${sweetsSubtotal.toFixed(2)}</span></div>
              </Section>
            </div>
            ...
            <div className="lg:col-span-1 min-w-0">
              <Section title="Bar (by consumption)">
                ...
                {enableBar && (
                  <div className="grid gap-2">
                    ...
                    <div className="rounded-lg border border-[#3a2a4a] p-3 bg-[#1b1526]/40">
              ...
              <Section title="Summary & Totals">
                <div className="rounded-2xl border border-[#3a2a4a] bg-[#1b1526]/40 p-4 shadow-sm">
                  ...
                  <hr className="my-3 border-[#3a2a4a]" />
                  <div className="flex justify-between text-lg font-semibold text-[#EAD8B1]">
                    <span>Grand Total</span>
                    <span>${grandTotal.toFixed(2)}</span>
                  </div>
                  <div className="mt-1 text-sm">≈ ${perGuest.toFixed(2)} per guest</div>
                </div>
              </Section>
            </div>
          </div>

          <footer className="mt-8 text-xs text-[#EAD8B1]/70">
            Built for Kayla & Patrick • March 21, 2026 • 1886 Crescent Hotel & Spa (Crystal Ballroom). Confirm final rates/availability with your coordinator.
          </footer>
        </div>
      </div>
    </div>
